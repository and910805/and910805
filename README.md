...
- 🌱 Passionate about **AI, cybersecurity, web development, and web scraping**.  
- ❤️ Enjoy exploring and analyzing data through **scripting and automation** (mainly Python).  
- 🌐 Portfolio site: [My Homepage](https://and910805.github.io/eric_site/)  
- 📫 Reach me at **goole910805@gmail.com**  

---

#### 中文版
- 👨‍💻 我的名字是 **莊冠霖 (Eric)**。  
- 🛡️ 目前任職於 **資安工程師**，具備弱點管理、EDR、Microsoft 365 與雲端資安經驗。  
- 🌱 對 **人工智慧、資訊安全、網頁開發與網路爬蟲** 充滿熱情。  
- ❤️ 熱衷於透過 **Python 腳本與自動化技術** 進行資料探索與分析。  
- 🌐 個人首頁：[點我進入](https://and910805.github.io/eric_site/)  
- 📫 聯絡方式：**goole910805@gmail.com**  
...
#### Security
![CEH](https://img.shields.io/badge/CEH-v13-red?style=flat-square&logo=hackaday&logoColor=white)
